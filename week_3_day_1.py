...
print ( name + " liked to hum the the song " + str(song) + " It was so annoying that their teammates would throw " + food + "s until " + name + " would stop singing")

# Still, [name] was the best coder on the team and could write [number] lines of code every day. Maybe [song] was [name]’s secret power?
print ("Stil " + name + " was the best coder on the team and could write " + str(number) + " lines of code every day. Maybe " + song + " was " + name + "'s secret power?")
...
print(10/2)
# #modulo
print(7%4) #remainder of the quotient
# #powers
print(2**3)
# #get the max and min of a number
print(max(1,2)) #max number means get the largest number
